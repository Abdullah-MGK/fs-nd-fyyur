...
# session.rollback()
engine = create_engine('postgresql://localhost:5432/fyyur')
...
for venue in venues:
    new_venue = Venue(
        ...
        image_link = venue.get('image_link'),
        facebook_link = venue.get('facebook_link'),
        seeking_talent = venue.get('seeking_talent'),
...
for artist in artists:
    new_artist = Artist(
        ...
        image_link = artist.get('image_link'),
        facebook_link = artist.get('facebook_link'),
        seeking_venue = artist.get('seeking_talent'),
